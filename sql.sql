...
-- Export de données de la table gta5.logs : ~0 rows (environ)
...
-- Export de données de la table gta5.server_factions : ~3 rows (environ)
/*!40000 ALTER TABLE `server_factions` DISABLE KEYS */;
INSERT INTO `server_factions` (`id`, `name`, `restricted`, `leader`, `desc`, `cop`) VALUES
	(1, 'Civil', 0, 'NoOne', 'Be a good or a bag boy', 0),
	(2, 'LSPD', 1, 'NoOne', 'be a cop', 1),
	(3, 'FIB', 1, 'NoOne', 'Better than cops, worse than SWAT', 1),
	(4, 'SWAT', 1, 'NoOne', 'The elite of the game', 1);
...
INSERT INTO `server_players` (`id`, `name`, `email`, `password`, `spenttime`, `cash`, `bank`, `wantedlevel`, `jail`, `hacker`) VALUES
	(1, 'Alexandre_Lasque', 'test@test.fr', 'dc96950fcc187d281129ab23c2eb598f', 2058, 759979, 66155, 5, 0, 801);
...
INSERT INTO `server_vehicles` (`id`, `faction_id`, `name`, `posx`, `posy`, `posz`, `angle`, `color1`, `color2`, `plate`, `locked`, `dimension`) VALUES
	...
	(4, 1, 'dilettante', 14.93, 5.42913, 69.8172, 250.931, 0, 0, 'Civil', 0, 0),
